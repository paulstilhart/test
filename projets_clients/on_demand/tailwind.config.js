    ...
    extend: {
      colors: {
        ...
        'primary':{
          '700': '#700642',
          'surface':{
            'xhigh': '#243D7C',//'var(--color-dark-blue-800)',
            'md': '#6987D3',//'var(--color-dark-blue-500)',
            'low': '#DFE6F6',//'var(--color-dark-blue-100)',
            'xlow': '#EFF2FA',//'var(--color-dark-blue-50)'
          },
          'text':{
            'xhigh': '#243D7C',//'var(--color-dark-blue-800)',
            'md': '#6987D3',//'var(--color-dark-blue-500)',
        ...
        'secondary':{
          'surface':{
            'xhigh': '#09919A',//'var(--color-dark-green-800)',
            'md': '#31C8D3',//'var(--color-dark-green-500)',
            'low': '#E1EAEA',//'var(--color-dark-green-100)',
            'xlow': '#ECEEEE',//'var(--color-dark-green-50)'
          },
          'text':{
            'md': '#31C8D3',//'var(--color-dark-green-500)',
          },
        ...
        'tertiary':{
          ...
          'blue':{
            'xhigh': '#0094E8',//'var(--color-blue-900)',
            'high': '#0AA5FF',//'var(--color-blue-800)',
            'md': '#47BCFF',//'var(--color-blue-600)',
            'low': '#85D2FF',//'var(--color-blue-400)',
          ...
          'red':{
            'xhigh': '#E4005B',//'var(--color-red-900)',
            'high': '#FF0569',//'var(--color-red-800)',
